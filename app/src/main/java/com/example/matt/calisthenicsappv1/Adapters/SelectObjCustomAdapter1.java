...
public class SelectObjCustomAdapter1 extends ArrayAdapter<String>{

    public SelectObjCustomAdapter1(Context context, /*This is the resource we're passing in*/ String[] exercises) {
