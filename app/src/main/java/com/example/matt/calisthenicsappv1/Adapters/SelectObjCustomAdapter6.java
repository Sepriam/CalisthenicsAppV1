...
public class SelectObjCustomAdapter6 extends ArrayAdapter<ExerciseObject>{

    public ArrayList<ExerciseObject> exerciseList;

    AppDBHandler db = new AppDBHandler(getContext());

    public SelectObjCustomAdapter6(@NonNull Context context, @LayoutRes int resource, /*This is the resource we're passing in*/ ArrayList<ExerciseObject> _exerciseList) {
