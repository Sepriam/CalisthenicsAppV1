...
public class SelectObjCustomAdapter3 extends ArrayAdapter<ExerciseObject>{

    public ArrayList<ExerciseObject> exerciseList;

    AppDBHandler db = new AppDBHandler(getContext());

    public SelectObjCustomAdapter3(@NonNull Context context, @LayoutRes int resource, /*This is the resource we're passing in*/ ArrayList<ExerciseObject> _exerciseList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SelectObjCustomAdapter3.ViewHolder holder = null;
        ...
        {
            holder = (SelectObjCustomAdapter3.ViewHolder) convertView.getTag();
        }
